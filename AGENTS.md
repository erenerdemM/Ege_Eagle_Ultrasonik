# EAGLEULTRASONİK — AGENT OS V2 MASTER ENTRYPOINT

# Fast Project State Bootstrap: Read PROJECT_STATE.md at session start
# Declarative Subagents: Defined in .agents/AGENTS.md
# Engineering Rules: Defined in .agents/rules/
# Skills: Defined in .agents/skills/

agents:
  - name: system-architect
    description: "System Architect — High-level architecture, multi-node state machines, and cross-subsystem protocol specifications."
    tools:
      - scope: "*.md"
      - scope: ".agent/reports/"
